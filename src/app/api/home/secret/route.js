...
const CACHE_KEY = 'homepage/secret';
const CACHE_TTL = 300;
...
export async function GET(req, res) {
    try {
        ...
        const response = await fetch("https://www.jiosaavn.com/api.php?__call=webapi.getLaunchData&api_version=4&_format=json&_marker=0&ctx=wap6dot0", {
            method: "GET",
            headers: {
